...
<table border="0">
	...
	<tr>
		...
		<td>No</td>
		<td>The mode of transport selected by the user for the current search. The event supports multiple parameters, each can be added using the addModeOfTransportation(ModeOfTransportation modeOfTransportation) method in the builder. See the javadoc for all possible modes of transportations.</td>
	</tr>
	<tr>
</table>
