## Developer Guide
The goal of this is to provide all the information a new developer would need to start with the development. If when using it if for some reason you need some additional information, please make sure that this README.md file is updated.
### Git workflow
 ...
 * Once everything is OK merge the release branch back to master and develop and this will tiger the travis job that creates the release.
